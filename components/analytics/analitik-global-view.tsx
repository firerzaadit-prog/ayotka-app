...
/**
 * Analitik Global: perbandingan antar sekolah + tren waktu + statistik
 * nasional per mata pelajaran. Dipakai SAMA PERSIS oleh admin pusat
 * (app/admin-pusat/analitik) dan dinas pendidikan (app/dinas-pendidikan/analitik)
 * - satu-satunya beda antara kedua role adalah endpoint API yang dituju
 * (masing-masing punya requireRole sendiri di server), UI-nya seragam.
 */
export function AnalitikGlobalView({
  analitikEndpoint,
  schoolsEndpoint,
  subjectsEndpoint,
}: {
